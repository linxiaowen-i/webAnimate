...
window.bbFeedback = function() {
    ...
    o.prototype = {
                ...
                success: function(h) {
                    if (0 == h.code) {
                        ...
                        if (n) {
                            var d = D.parent(),
                            a = d.find(".re_ul"),
                            b = d.find(".pagelistbox"),
                            e = parseInt(b.attr("data-page")),
                            g = parseInt(b.attr("data-results")) || a.children().length; (d.find(".re_more").length || e) && e != Math.ceil(g / 10) || setTimeout(function() {
                                p.loadReply(b, a, k || n, Math.ceil((g + 1) / 10))
                            },
                            200)
                        }
                        p.removeCaptcha();
                ...
                ajaxEmojiRender: function(I) {
                    ...
                    if (I || !I.code || I.data.length) {
                        for (var H = 0; H < I.data.length; H++) {
                            if (b = "", k = I.data[H], l = k.emojis, $.isArray(l) && l.length && !k.pstate) {
                                null == p.firsrPid && (p.firsrPid = k.pid);
                                for (var a = 0; a < l.length; a++) {
                                    1 != l[a].state && (g = l[a], h = (g.name.split("_")[1] || "").slice(0, -1), b += '<span data-emoji-text="' + g.name + '"><img title="' + h + '" alt="' + g.name + '" data-id="' + g.id + '" data-state="' + g.state + '" data-img="' + utils.thumbnail(g.url, 40) + '"></span>')
                                }
                                F[k.pid] = b;
        ...
        load: function(D, B, z) {
            function p() {
                if (!e._loaded) {
                    C.addClass("b-load-fail").html("<span>\u52a0\u8f7d\u5931\u8d25\uff0c<a>\u70b9\u51fb\u91cd\u8bd5</a></span>").find("a").on("click",
                    function() {
                        e.load(D, B, z)
                    })
                }
            ...
            function f(l, c) {
                ...
                if (12002 === l.code) {
                    ...
                    if (0 !== l.code || "object" != typeof l.data) {
                        p()
                    } else {
                        $(".common .b-head .results").html(l.data.page.acount).show();
                        B && l.data.page && (e.page = D = l.data.page.num);
                        e._loaded = !0;
                        ...
                        l.data.need_captcha ? (e.needCaptcha = !0, e.createCaptcha(b, l.data.url)) : (e.needCaptcha = !1, e.removeCaptcha());
                        ...
                        $("li", a).click(function() {
                            var A = $(this);
                            A.hasClass("on") || ($("li", a).removeClass("on"), A.addClass("on"), e.orderby = A.attr("order"), e.load(1))
                        });
                        var k = $('<ul class="comm_list"></ul>').appendTo(b),
                        n = $('<div class="pagelistbox"></div>').appendTo(b),
                        g = $('<div class="pagelistbox small"></div>').appendTo(a);
                        pagelist(n, D, Math.ceil(l.data.page.count / l.data.page.size), l.data.page.count,
                        function(A) {
                            e.load(A);
                        ...
                        pagelist(g, D, Math.ceil(l.data.page.count / l.data.page.size), l.data.page.count,
                        function(A) {
                            e.load(A)
                        },
                        null, 2);
                        l.data.replies.length && 0 != l.data.page.acount || $('<div class="no_more">\u6ca1\u6709\u66f4\u591a\u4fe1\u606f</div>').appendTo(k);
                        l.data.top && (l.data.top.content && l.data.page && 1 === l.data.page.num) && (l.data.top.content.message = '<span class="comm-top-stick">\u7f6e\u9876</span>' + l.data.top.content.message, $.isArray(l.data.replies) && l.data.replies.unshift(l.data.top));
                        for (n = 0; n < l.data.replies.length; n++) {
                            "object" == typeof l.data.replies[n] &&
                            function(F) {
                                if (F.member && F.content) {
                                    var L = "";
                                    F.member && F.member.official_verify && 0 == F.member.official_verify.type ? L = '<div class="legalize-16-1" style=\'position:absolute;top:50px;left:50px;\' title="\u4e2a\u4eba\u8ba4\u8bc1"></div>': F.member && (F.member.official_verify && 1 == F.member.official_verify.type) && (L = '<div class="legalize-16-2" style=\'position:absolute;top:50px;left:50px;\' title="\u4f01\u4e1a/\u56e2\u4f53\u8ba4\u8bc1"></div>');
                                    0 === F.root && F.content.message && (F.content.message = F.content.message.replace(/\[[^\[]*]/g,
                                    function(M) {
                                        return $("<img>", c[M]).prop("outerHTML") || M
                                    }));
                                    var J = $('<li id="l_id_' + F.rpid + '" class="main-floor"><div class="facebox"><a href="//space.bilibili.com/' + F.member.mid + '" target="_blank" mid="' + F.member.mid + '" card="' + F.member.uname + '"><img src="' + utils.thumbnail(F.member.avatar, 52, 52) + '" class="face"></a><a href="//space.bilibili.com/' + F.member.mid + '" mid="' + F.member.mid + '" target="_blank" class="face_bg" card="' + F.member.uname + '">' + (F.member.pendant && 0 < F.member.pendant.pid ? '<img src="' + utils.thumbnail(F.member.pendant.image, 86) + '" alt="' + F.member.pendant.name + '" />': "") + L + '</a></div><div class="t"><a href="//space.bilibili.com/' + F.member.mid + '" target="_blank" mid="' + F.member.mid + '" card="' + $("<div/>").text(F.member.uname).html() + '">' + $("<div/>").text(F.member.uname).html() + '</a><a href="//www.bilibili.com/html/help.html#k_3" target="_blank" class="user-info-level l' + (F.member.level_info ? F.member.level_info.current_level: 0) + '"></a>' + (F.member.nameplate && 0 < F.member.nameplate.nid ? '<a href="https://account.bilibili.com/site/nameplate" target="_blank" class="member-nameplate" nameplate-id="' + F.member.nameplate.nid + '"><img src="' + utils.thumbnail(F.member.nameplate.image_small, 32) + '" alt="' + F.member.nameplate.name + '" /></a>': "") + '</div><div class="content"></div><div class="elinfo"><span class="floor-num">#' + F.floor + "</span>" + (F.content.plat && 1 < F.content.plat ? '<span class="floor-plat">\u6765\u81ea<a href="//app.bilibili.com/" target="_blank">' + ("2" == F.content.plat ? "\u5b89\u5353\u5ba2\u6237\u7aef": "") + ("3" == F.content.plat ? "iOS\u5ba2\u6237\u7aef": "") + ("4" == F.content.plat ? "Windows Phone\u5ba2\u6237\u7aef": "") + "</a></span>": "") + '<span class="floor-date">' + t(F.ctime) + '</span></span><i class="report"></i></div></li>').appendTo(k);
                                    F.member.vip && (2 == F.member.vip.vipType && 0 != F.member.vip.vipStatus && 2 != F.member.vip.vipStatus) && J.find(".t > a").eq(0).addClass("b-vip-red");
                                    e.pushUser(F.member.mid, J);
                                    L = J.find(".content");
                                    e.recordToObject(L, F);
                                    if (null != F.replies) {
                                        for (var H = $('<div class="reply"><ul class="re_ul"></ul><div class="re_box">' + (5 < F.rcount ? '<p class="re_more"><span>\u8fd8\u6709<b>' + (F.rcount - 5) + '</b>\u6761\u56de\u590d\uff0c</span><a class="re_more_s">\u70b9\u51fb\u67e5\u770b</a></p>': "") + '<div class="re_page">   <div class="pagelistbox small">   </div></div></div><div class="re_send"></div></div>').appendTo(J), A = $(".re_ul", H), K = 1, L = 0; L < F.replies.length; L++) {
                                            e.reply_render(F.replies[L], F.rpid, A),
                                            B && (F.replies[L].rpid == B && l.data.page.rt_num) && (K = l.data.page.rt_num)
                                        }
                                        $(".re_more_s", H).click(function() {
                                            $(".re_more", H).remove();
                                            e.loadReply($(".pagelistbox", H), A, F.rpid, K)
                                        })
                                    }
                                    var L = J.find(".report"),
                                    I,
                                    G = $('<a href="javascript:;" class="huifu">\u56de\u590d</a>').appendTo(L).click(function() {
                                        0 == J.find(".reply").length ? (I = $('<div class="reply"><ul class="re_ul"></ul><div class="re_box"><p class="j_re"><a class="re_send_s" href="javascript:;">\u53c2\u4e0e\u56de\u590d</a></p><div class="re_page"> <div class="pagelistbox"></div></div></div><div class="re_send"></div></div>').appendTo(J), $(".re_box", I).hide(), $(".re_send_s", I).click(function() {
                                            e.re_send_show(I.find(".re_send"), null, F.rpid)
                                        })) : I = J.find(".reply");
                                        I.find(".re_ul");
                                        e.re_send_show(I.find(".re_send"), null, F.rpid)
                                    });
                                    F.replies && F.replies.length && G.addClass("reply-b").text("\u53c2\u4e0e\u56de\u590d");
                                    0 <= e.isAdmin && ($('<a class="jubao">\u4e3e\u62a5</a>').appendTo(L).click(function() {
                                        return u(this, e.id, e.type, F.rpid)
                                    }), e.bindAgree($('<a href="javascript:;" class="zan"></a>').prependTo(L), F));
                                    1 == e.isAdmin && (G = $('<a href="javascript:;" title="\u88ab\u9690\u85cf\u540e\uff0c\u5176\u4ed6\u7528\u6237\u4f1a\u9ed8\u8ba4\u4e0d\u663e\u793a\u8be5\u8bc4\u8bba" class="no hidefb">\u9690\u85cf\u8be5\u8bc4\u8bba</a>').appendTo(L).click(function() {
                                        v(this, h, e.type, F.rpid, !0);
                                        return ! 1
                                    }), L = $('<a href="javascript:;" class="yes showfb">\u663e\u793a\u8be5\u8bc4\u8bba</a>').appendTo(L).click(function() {
                                        v(this, h, e.type, F.rpid, !1);
                                        return ! 1
                                    }), 0 == F.state || 6 == F.state || 2 == F.state ? L.hide() : G.hide())
                                }
                            } (l.data.replies[n])
                        }
                        e.checkFeed(e.id);
                        "pc" == e.platform && (bindCardEvent(b), bindNameplateEvent(b));
                        "function" == typeof z && z(b);
            ...
            D = this.page;
            var e = this,
            E = 4 == e.type ? 4 : "topic" == e.type ? 2 : 1,
            d = i.base + i.list.getReply + "?jsonp=jsonp&type=" + E + "&sort=" + e.orderby + "&oid=" + e.id + "&pn=" + D + "&r=" + Math.random() + "&nohot=1";
            B && (d = i.base + i.list.getPosition + "?jsonp=jsonp&rpid=" + B + "&type=" + E + "&oid=" + e.id + "&pn=" + D + "&r=" + Math.random() + "&nohot=1");
            this.target.find(".b-loading").remove();
            if (!e._loaded) {
                var C = $('<div class="b-loading"></div>').appendTo(this.target)
            }
            $.when($.ajax({
                dataType: "jsonp",
                url: d
                ...
                if (G && !G.code && G.data.length) {
                    for (var F = 0; F < G.data.length; F++) {
                        var A = G.data[F].emojis;
                        if ($.isArray(A) && A.length) {
                            for (var n = 0; n < A.length; n++) {
                                H[A[n].name] = {
                                    "class": "b-vip-emoji",
                                    title: (A[n].name.split("_")[1] || "").slice(0, -1),
                                    src: utils.thumbnail(A[n].url, 50),
                                    alt: A[n].name
                                }
                            }
                        }
...
function profileWnd(B) {
    ...
    if (z.length) {
        ...
        if (0 == B.email_verified && 0 == B.mobile_verified) {
            var v = $('<a class="phone" href="https://passport.bilibili.com/member/bindphone.html" target="_blank"></a>').attr({
                tips: "\u524d\u53bb\u7ed1\u5b9a\u624b\u673a",
                "tips-pos": "l"
            }),
            u = $('<a class="email" href="https://passport.bilibili.com/member/bindmail.html" target="_blank"></a>').attr({
                tips: "\u524d\u53bb\u7ed1\u5b9a\u90ae\u7bb1",
                "tips-pos": "l"
            })
        } else {
            1 == B.email_verified && 0 == B.mobile_verified ? (v = $('<a class="phone" href="https://passport.bilibili.com/member/hasmailcheckmail.html" target="_blank"></a>').attr({
                tips: "\u524d\u53bb\u7ed1\u5b9a\u624b\u673a",
                "tips-pos": "l"
            }), u = $('<a class="email verified" href="https://account.bilibili.com/" target="_blank"></a>').attr({
                tips: "\u5df2\u7ed1\u5b9a",
                "tips-pos": "l"
            })) : 0 == B.email_verified && 1 == B.mobile_verified ? (v = $('<a class="phone verified" href="https://account.bilibili.com/" target="_blank"></a>').attr({
                tips: "\u5df2\u7ed1\u5b9a",
                "tips-pos": "l"
            }), u = $('<a class="email" href="https://passport.bilibili.com/member/hasphonecheckphone.html" target="_blank"></a>').attr({
                tips: "\u524d\u53bb\u7ed1\u5b9a\u90ae\u7bb1",
                "tips-pos": "l"
            })) : 1 == B.email_verified && 1 == B.mobile_verified && (v = $('<a class="phone verified" href="https://account.bilibili.com/" target="_blank"></a>').attr({
                tips: "\u5df2\u7ed1\u5b9a",
                "tips-pos": "l"
            }), u = $('<a class="email verified" href="https://account.bilibili.com/" target="_blank"></a>').attr({
                tips: "\u5df2\u7ed1\u5b9a",
        ...
        B.pendant && B.pendant.image ? ($("<img>", {
            "class": "i_face-pendant hide",
            src: utils.trimHttp(B.pendant.image),
            alt: B.pendant.name
        }).insertAfter(y), y.addClass("has_pendant")) : y.removeClass("has_pendant");
        var r = $(".i_face-pendant"),
        s = function() {
            var d = [],
            c = new Date;
        ...
        function() {
            ...
            A.is(":visible") || (y.addClass("scale-in"), b[c] == s() && w.removeClass("hover-first").addClass("hover-again"), A.stop().slideDown(200,
            function() {
                r.removeClass("hide");
                $(".legalize-icon", z).show();
                b[c] != s() && B.mobile_verified && (b[c] = s(), utils.localStorage.setItem("time_tracker", JSON.stringify(b)), $("#i_menu_profile .info a.linkToCurrency").addClass("off"), setTimeout(function() {
                    $("#i_menu_profile .info a.linkToCurrency").removeClass("off").addClass("on")
                },
                3000), w.removeClass("hover-again").addClass("hover-first"))
            }))
        },
        function() {
            r.addClass("hide");
            ...
            A.stop().slideUp(200,
            function() {
                w.removeClass("hover-first hover-again")
            });
        ...
        for (var o in B.level_info) {
            B.level_info[o] = parseInt(B.level_info[o]) >> 0
        }
        0 === B.level_info.next_exp >> 0 && (B.level_info.next_exp = "-");
        v = B.level_info;
        u = $('<a class="help-link" href="//www.bilibili.com/html/help.html#k" target="_blank">\u4f1a\u5458\u7b49\u7ea7\u76f8\u5173\u8bf4\u660e ></a>');
        o = $('<div class="user-info" id="lv_info"><div class="user-info-hd"><span class="t">\u7b49\u7ea7</span></div><div class="points-wrp" id="exp_wrp"><a href="https://account.bilibili.com/site/record?type=exp" target="_blank"><div class="points-cnt"><div class="lt"></div><div class="fill-el"></div><div class="bar"><div class="points"></div></div><div class="points-schedule"><span class="now-points">' + v.current_exp + '</span><span class="next-points">/' + v.next_exp + "</span></div></div></a></div></div>").addClass("l" + v.current_level).insertAfter(A.find(".info"));
        var i = o.find("#exp_wrp");
        0 == v.current_level && o.find(".points-schedule").html('<a class="lv-0" href="https://account.bilibili.com/answer/base" target="_blank">\u7b54\u9898\u8f6c\u6b63\u76f4\u5347Lv' + (v.after_answer || 2) + "</a>");
        var C = $('<div class="user-info-desc"><span class="arrow-left"></span><div class="lv-row">\u4f5c\u4e3a<strong>LV' + v.current_level + "</strong>" + (0 == v.current_level ? "\uff0c\u4f60\u65e0\u6cd5\u4eab\u53d7\u7279\u6743": "\uff0c\u4f60\u53ef\u4ee5\uff1a") + "</div><div>" + "\u6210\u4e3a\u6b63\u5f0f\u4f1a\u5458\uff0c\u4f60\u53ef\u4ee5\uff1a<br/>1\u3001\u53d1\u5c04\u4e2a\u6027\u5f39\u5e55<br/>2\u3001\u53c2\u4e0e\u89c6\u9891\u8bc4\u8bba<br/>3\u3001\u767b\u5f55\u83b7\u5f97\u786c\u5e01<br/>4\u3001\u6295\u7a3f\u6210\u4e3a\u5076\u50cf 1\u3001\u53d1\u5c04\u6eda\u52a8\u5f39\u5e55<br/>2\u3001\u6295\u7a3f\u6210\u4e3a\u5076\u50cf 1\u3001\u53d1\u5c04\u4e2a\u6027\u5f39\u5e55\uff08\u5f69\u8272\u3001\u9ad8\u7ea7\uff09<br/>2\u3001\u53c2\u4e0e\u89c6\u9891\u4e92\u52a8\uff08\u8bc4\u8bba\uff09<br/>3\u3001\u6295\u7a3f\u6210\u4e3a\u5076\u50cf 1\u3001\u53d1\u5c04\u4e2a\u6027\u5f39\u5e55\uff08\u5f69\u8272\u3001\u9ad8\u7ea7\u3001\u9876\u90e8\u3001\u5e95\u90e8\uff09<br/>2\u3001\u53c2\u4e0e\u89c6\u9891\u4e92\u52a8\uff08\u8bc4\u8bba\u3001\u6dfb\u52a0tag\uff09<br/>3\u3001\u6295\u7a3f\u6210\u4e3a\u5076\u50cf 1\u3001\u53d1\u5c04\u4e2a\u6027\u5f39\u5e55\uff08\u5f69\u8272\u3001\u9ad8\u7ea7\u3001\u9876\u90e8\u3001\u5e95\u90e8\uff09<br/>2\u3001\u53c2\u4e0e\u89c6\u9891\u4e92\u52a8\uff08\u8bc4\u8bba\u3001\u6dfb\u52a0tag\uff09<br/>3\u3001\u6295\u7a3f\u6210\u4e3a\u5076\u50cf 1\u3001\u8d2d\u4e70\u9080\u8bf7\u7801\uff081\u4e2a/\u6708\uff09<br/>2\u3001\u53d1\u5c04\u4e2a\u6027\u5f39\u5e55\uff08\u5f69\u8272\u3001\u9ad8\u7ea7\u3001\u9876\u90e8\u3001\u5e95\u90e8\uff09<br/>3\u3001\u53c2\u4e0e\u89c6\u9891\u4e92\u52a8\uff08\u8bc4\u8bba\u3001\u6dfb\u52a0tag\uff09<br/>4\u3001\u6295\u7a3f\u6210\u4e3a\u5076\u50cf 1\u3001\u8d2d\u4e70\u9080\u8bf7\u7801\uff082\u4e2a/\u6708\uff09<br/>2\u3001\u53d1\u5c04\u4e2a\u6027\u5f39\u5e55\uff08\u5f69\u8272\u3001\u9ad8\u7ea7\u3001\u9876\u90e8\u3001\u5e95\u90e8\uff09<br/>3\u3001\u53c2\u4e0e\u89c6\u9891\u4e92\u52a8\uff08\u8bc4\u8bba\u3001\u6dfb\u52a0tag\uff09<br/>4\u3001\u6295\u7a3f\u6210\u4e3a\u5076\u50cf".split(" ")[v.current_level] + "</div></div>").hide().appendTo(i);
        o.mouseenter(function(b) {
            clearTimeout(j);
        ...
        o.find(".user-info-desc").append(u);
        6 == v.current_level ? o.find(".points").css("width", "100%") : o.find(".points").css("width", (100 * (v.current_exp / v.next_exp) >> 0) + "%");
        ...
        j = {
            ...
            append: function(D) {
                ...
                case 1:
                    ...
                    C = utils.trimHttp(G.pic);
                    A = G.author;
                    s = 'card="' + G.author + '" mid="' + G.mid + '"';
                    z = "<span>\u6295\u7a3f\u4e86</span>";
                    y = G.title;
                    x = "//space.bilibili.com/" + G.mid;
                    t = utils.trimHttp(G.link);
                    r = " v";
                    break;
                case 3:
                    C = utils.trimHttp(D.source.cover);
                    A = D.source.title;
                    z = "<span>\u66f4\u65b0\u4e86</span>";
                    F = '<span class="sp">\u756a\u5267</span>';
                    y = G.title;
                    x = "//bangumi.bilibili.com/anime/" + D.source.season_id + "/";
                    t = utils.trimHttp(G.link);
                    break;
                case 5:
                    C = utils.trimHttp(D.source.cover);
                    A = D.source.title;
                    z = "<span>\u6dfb\u52a0\u4e86</span>";
                    F = '<span class="sp">\u4e13\u9898</span>';
                    y = G.title;
                    x = "//bilibili.com/sp/" + A;
                    t = utils.trimHttp(G.link);
                    break;
                case 6:
                    C = utils.trimHttp(D.source.avatar),
                    A = D.source.uname,
                    s = 'card="' + D.source.uname + '" mid="' + D.source.mid + '"',
                    z = "<span>\u53d1\u8868\u4e86\u8bc4\u8bba</span>",
                    y = D.content.msg,
                    x = "//space.bilibili.com/" + D.source.mid,
                    t = utils.trimHttp(G.link + D.content.flink),
                    r = " u"
                }
                return $('<li class="d-data"><div class="preview' + r + '"><img src="' + utils.trimHttp(C) + '" /></div><div class="r"><div class="title">' + (F ? F: "") + E + '<a href="' + x + '"' + ("" != s ? s: "") + ' target="_blank">' + A + "</a>" + z + '</div><div class="info"><a href="' + t + '" target="_blank" title="' + (6 != D.type ? y: G.title) + '">' + y + "</a></div></div></li>")
            },
            onData: function(d) {
...
function initMiniWnd() {
    ...
    function v(a) {
        var c = y(new Date);
        a = y(new Date(a + 86400000));
        return w(a, c)
    }
    function u(a) {
        for (var l = !1,
        k = y(new Date), h = 2; 8 > h; h++) {
            var c = y(new Date(a + 86400000 * h));
            if (w(c, k)) {
                l = !0;
                break
            }
    ...
    if (UserStatus.status().isLogin) {
        var r = $("#i_menu_fav_btn"),
        o = $("#i_menu_history_btn"),
        q = new MiniWnd;
        if (r.length) {
            var i = {
                ...
                render: function(g, f) {
                    ...
                    l.empty();
                    for (var h in k) {
                        "object" == typeof k[h] && (null != k[h].title ? $('<li><a href="//www.bilibili.com/video/av' + k[h].aid + '" target="_blank" title="' + k[h].title + '">' + k[h].title + "</a></li>") : $('<li><a href="//www.bilibili.com/mylist' + k[h].lid + '" target="_blank" title="' + k[h].description + '">' + k[h].description + "</a></li>")).appendTo(l)
                    }
        ...
        if (o.length) {
            r = {
                wnd: $('<div class="mini-wnd"><div class="top-open-history"><p class="txt">\u5386\u53f2\u529f\u80fd\u6682\u505c\u4e2d\uff0c\u5c31\u7b97\u770b\u4e0d\u53ef\u63cf\u8ff0\u7684\u89c6\u9891\u4e5f\u4e0d\u4f1a\u88ab\u8bb0\u5f55\u4e0b\u6765\u4e86</p><a class="openbtn">\u524d\u53bb\u5f00\u542f</a></div><ul class="list history"></ul><a class="read-more">\u67e5\u770b\u66f4\u591a<i class="b-icon b-icon-arrow-r"></i></a></div>'),
                ...
                render: function(C, g) {
                    ...
                    for (F in f) {
                        if ("object" == typeof f[F]) {
                            var B = 1000 * f[F].view_at,
                            D = $('<li class="timeline"><span class="date"></span></li>');
                            x(B) && !a ? (D.find(".date").html("\u4eca\u65e5"), D.appendTo(e), a = !0) : v(B) && !d ? (D.find(".date").html("\u6628\u65e5"), D.appendTo(e), d = !0) : u(B) && !H ? (D.find(".date").html("\u8fd11\u5468"), D.appendTo(e), H = !0) : t(B) && !G ? (D.find(".date").html("1\u5468\u524d"), D.appendTo(e), G = !0) : s(B) && !b ? (D.find(".date").html("1\u4e2a\u6708\u524d"), D.appendTo(e), b = !0) : x(B) || (v(B) || u(B) || t(B) || s(B)) || (D.find(".date").html((new Date(1000 * f[F].view_at)).format("yyyy-MM-dd hh:mm:ss")), D.appendTo(e));
                            if (null != f[F].title) {
                                var I = $('<li><a  class="item-a" href="//www.bilibili.com/video/av' + f[F].aid + '" target="_blank" title="' + f[F].title + '" data-aid="' + f[F].aid + '">' + f[F].title + "</a></li>")
                            }
                            I.appendTo(e)
                        }
                    }
                    0 == e.children().length && (e.addClass("empty"), $('<li class="no-data">\u6ca1\u6709\u6570\u636e\u54e6\uff0c\u591a\u770b\u70b9\u89c6\u9891\u5427</li>').appendTo(e))
                }
            };
            q.init(o, r);
            var j = $(".top-open-history");
            o.find(".i-link").on("click",
            function(b) {
                b.preventDefault();
                rec_rp("event", "nav_righttoolbar_history_click");
                window.open("//www.bilibili.com/account/history")
            });
            j.find(".openbtn").on("click",
            function(b) {
                b.preventDefault();
                window.open("//www.bilibili.com/account/history")
            });
            j.siblings(".read-more").on("click",
            function(b) {
                b.preventDefault();
                rec_rp("event", "nav_righttoolbar_history_more_click");
                window.open("//www.bilibili.com/account/history")
            });
            j.siblings(".list").on("click",
            function(b) {
                b.preventDefault();
                b = $(b.target) || $(b.srcElement);
                b.hasClass("item-a") && (console.log(22), rec_rp("event", "nav_righttoolbar_history_tovideoplaypage"), window.open("//www.bilibili.com/video/av" + b.data("aid")))
            });
            j.length && $.ajax({
        ...
        function(e) {
            ...
            if (j && j.link) {
                ...
                if ("bilibili\u7ed9\u60a8\u62dc\u5e74\u5566" == j.title) {
                    var d = "//static.hdslb.com/activity/bnj2016/img/fire1.gif",
                    a = $(),
                    l = $("<div>").css({
                        left: 0
                    }).append($("<img>").css({
                    ...
                    function() {
                        ...
                        h = setTimeout(function() {
                            ...
                            g.css("right", -(l.width() - 50)).find("img").attr("src", utils.trimHttp("//static.hdslb.com/activity/bnj2016/img/fire3.gif"));
                            0 > l.offset().left && l.width(parseInt($(".header .menu-wrapper").offset().left + 50)).css("left", -(l.width() - 50));
                            g.offset().left + g.width() > $(window).width() && g.width(parseInt($(window).width() - $(".header .menu-wrapper").offset().left - $(".header .menu-wrapper").outerWidth() + 50)).css("right", -(l.width() - 50))
                        },
                        100)
                    }).on("mouseleave",
                    function() {
